...
def fetch_poster(music_turtle):
    response=requests.get("https://saavn.dev/api/search/songs?query={}".format(music_turtle))
    data=response.json()
...
music_dict=pickle.load(open(r'/Users/cartneyhlauffin/musicrec.pkl','rb'))
music=pd.DataFrame(music_dict)

similarity=pickle.load(open(r'/Users/cartneyhlauffin/similarities.pkl','rb'))
